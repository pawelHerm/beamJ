...
public final class SesquilinearIntercept implements FittedLinearUnivariateFunction
{
    private final double a;
    private final double b;

    public SesquilinearIntercept(double factor, double intercept)
    {
        this.a = factor;
        this.b = intercept;
    }
    ...
    @Override
    public SesquilinearIntercept multiply(double s)
    {
        return new SesquilinearIntercept(s*a, s*b);
    }
