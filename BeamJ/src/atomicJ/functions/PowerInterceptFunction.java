...
public final class PowerInterceptFunction implements FittedLinearUnivariateFunction
{
    private final double a;
    private final double b;
    private final double exp;

    public PowerInterceptFunction(double a, double exp, double b)
    {
        this.a = a;
        this.exp = exp;
        this.b = b;
    ...
    @Override
    public PowerInterceptFunction multiply(double s)
    {
        return new PowerInterceptFunction(s*a, exp, s*b);
    }
