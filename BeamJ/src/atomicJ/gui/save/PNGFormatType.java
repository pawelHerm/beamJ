...
public class PNGFormatType extends AbstractImageFormatType
{
    private static final String DESCRIPTION = "PNG image (.png)";
    ...
    public ChartSaver getChartSaver() 
    {
        ...
        PNGFormatSaver saver = new PNGFormatSaver(chartInitialArea, width, height, saveDataArea);
        return saver;
    }
