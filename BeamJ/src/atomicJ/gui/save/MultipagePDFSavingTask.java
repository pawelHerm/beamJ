...
public class MultipagePDFSavingTask extends MonitoredSwingWorker<Void, Void> 
{
    ...
    private MultipagePDFSavingTask(Component parent, List<? extends JFreeChart> charts, List<String> names, ChartSaver saver, File path)
    {
    ...
    public static MultipagePDFSavingTask getZipSavingTask(List<? extends JFreeChart> charts, List<String> names, ChartSaver saver, File path, Component parent)
    {
        ...
        MultipagePDFSavingTask task = new MultipagePDFSavingTask(parent, charts, names, saver, path);
        return task;
    }
