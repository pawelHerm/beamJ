...
public class TarSavingTask extends MonitoredSwingWorker<Void, Void> 
{
    ...
    private TarSavingTask(Component parent, List<StreamSavable> savables, File path)
    {
    ...
    public static TarSavingTask getSavingTask(List<StreamSavable> savables, File path, Component parent)
    {
        if(path.isDirectory())
        {
        ...
        TarSavingTask task = new TarSavingTask(parent, savables, path);
        return task;
    }
