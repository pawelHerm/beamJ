...
public class PSFormatType extends AbstractDocumentFormatType
{
    private static final String DESCRIPTION = "PostScript document (.ps)";
    ...
    public ChartSaver getChartSaver() 
    {
        ...
        PSFormatSaver saver = new PSFormatSaver(chartInitialArea, width, height,properties, saveDataArea);
        return saver;
    }
