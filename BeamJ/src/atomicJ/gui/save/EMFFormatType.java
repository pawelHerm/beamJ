...
public class EMFFormatType extends AbstractImageFormatType
{
    private static final String DESCRIPTION = "Windows Enhanced Metafile (.emf)";
    private static final String EXTENSION = "emf";
    ...
    public ChartSaver getChartSaver() 
    {
        ...
        EMFFormatSaver saver = new EMFFormatSaver(chartInitialArea, width, height, saveDataArea);
