...
public class JPEG2000FormatType implements ChartSaveFormatType
{
    private static final String DESCRIPTION = "JPEG2000 image (.jp2)";
    private static final String EXTENSION = "jp2";

    private final JPEG2000FormatModel model = new JPEG2000FormatModel();
    private final JPEG2000FormatPanel panel = new JPEG2000FormatPanel(model);
