...
public class TIFFMultipageFormatType implements ChartSaveFormatType
{
    ...
    private final TIFFMultipageFormatModel model = new TIFFMultipageFormatModel();
    private final TIFFMultipageFormatPanel panel = new TIFFMultipageFormatPanel(model);
