...
public class EPSFormatType extends AbstractDocumentFormatType
{
    private static final String DESCRIPTION = "Encapsulated PostScript (.eps)";
    ...
    public ChartSaver getChartSaver() 
    {
        ...
        EPSFormatSaver saver = new EPSFormatSaver(chartInitialArea, width, height, properties, saveDataArea);
        return saver;
    }
