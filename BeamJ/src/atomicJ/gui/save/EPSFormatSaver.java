...
public class EPSFormatSaver extends BasicImageFormatSaver
{
    private static final String EXT = ".eps";

    private final Properties properties;

    public EPSFormatSaver(Rectangle2D chartInitialArea, int width, int height, Properties properties, boolean saveDataArea)
    {
    ...
    public void saveChart(JFreeChart chart, File path, ChartRenderingInfo info) throws IOException 
    {
        ...
        VectorGraphics g2d = new EPSGraphics2D(out,new Dimension(getWidth(),getHeight()));
    ...
    {
        EPSGraphics2D g2d = new EPSGraphics2D(out,new Dimension(getWidth(),getHeight()));
        g2d.setProperties(properties);
        g2d.startExport();
        paintOnGraphicsDevice(chart, g2d);
        g2d.writeTrailer();
