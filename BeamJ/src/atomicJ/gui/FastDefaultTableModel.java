 ...
 * @see #getDataVector
 */
public class FastDefaultTableModel extends AbstractTableModel implements Serializable {
     ...
     * @see #setValueAt
     */
    public FastDefaultTableModel(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public FastDefaultTableModel(Vector columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public FastDefaultTableModel(Object[] columnNames, int rowCount) {
     ...
     * @see #setDataVector
     */
    public FastDefaultTableModel(Vector data, Vector columnNames) {
     ...
     * @see #setDataVector
     */
    public FastDefaultTableModel(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
    ...
    public void addRows(Object[][] rowData) {
        insertRows(getRowCount(), rowData);
    }
    ...
    public void insertRows(int row, Object[][] rowData) 
    {
        ...
        for(int i = 0; i<n; i++)
        {
            dataVector.insertElementAt(convertToVector(rowData[i]), row + i);
        }

        justifyRows(row, row + n);
        fireTableRowsInserted(row, row + n - 1);
    }
