 ...
 */
public abstract class ValueAxisLightweight extends Axis
implements Cloneable, PublicCloneable, Serializable {
    ...
    private static final Polygon UP_ARROW =  new Polygon();
    static {UP_ARROW.addPoint(0, 0);
    UP_ARROW.addPoint(-2, 2);
    UP_ARROW.addPoint(2, 2);}

    private static final Polygon DOWN_ARROW = new Polygon();
    static {DOWN_ARROW.addPoint(0, 0);
    DOWN_ARROW.addPoint(-2, -2);
    DOWN_ARROW.addPoint(2, -2);}

    private static final Polygon RIGHT_ARROW = new Polygon();
    {RIGHT_ARROW.addPoint(0, 0);
    RIGHT_ARROW.addPoint(-2, -2);
    RIGHT_ARROW.addPoint(-2, 2);}

    private static final Polygon LEFT_ARROW = new Polygon();
    {LEFT_ARROW.addPoint(0, 0);
    LEFT_ARROW.addPoint(2, -2);
    LEFT_ARROW.addPoint(2, 2);}
     ...
     */
    protected ValueAxisLightweight(String label, TickUnitSource standardTickUnits) {
        ...
        this.upArrow = UP_ARROW;
        this.downArrow = DOWN_ARROW;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ValueAxisLightweight)) {
            return false;
        }
        ValueAxisLightweight that = (ValueAxisLightweight) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        ValueAxisLightweight clone = (ValueAxisLightweight) super.clone();
        return clone;
    }
