...
import atomicJ.imageProcessing.KernelLaplacianOfGaussian;
import atomicJ.resources.Channel2DResource;
import atomicJ.resources.ResourceView;

public class LaplacianOfGaussianFilterModel extends GaussianBasedFilter2DModel
{
    public LaplacianOfGaussianFilterModel(ResourceView<Channel2DResource, Channel2D, String> manager, ChannelFilter2<Channel2D> channelFilter)
    {
    ...
    protected Channel2DDataInROITransformation buildTransformation()
    {
        ...
        Kernel2D kernel = new KernelLaplacianOfGaussian(getSigmaX(), getSigmaY());
