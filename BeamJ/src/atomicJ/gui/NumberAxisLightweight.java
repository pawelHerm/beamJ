 ...
 */
public class NumberAxisLightweight extends ValueAxis implements Cloneable, Serializable {
     ...
     */
    public NumberAxisLightweight(String label) {
        super(label, NumberAxisLightweight.createStandardTickUnits());
    ...
    public Object clone() throws CloneNotSupportedException {
        NumberAxisLightweight clone = (NumberAxisLightweight) super.clone();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NumberAxisLightweight)) {
            return false;
        }
        NumberAxisLightweight that = (NumberAxisLightweight) obj;
