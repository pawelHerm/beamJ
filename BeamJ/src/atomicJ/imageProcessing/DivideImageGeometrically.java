 ...
 * The operation performed is a linear combination of images a*A/B, where A is the image matrix passed as an argument to the {@link DivideImageGeometrically#transform}
 * method, the image matrix B is passed to the constructor, just as is the scalar factor a.
 *
 */

public class DivideImageGeometrically implements Channel2DDataInROITransformation
{   
    ...
    public DivideImageGeometrically(Channel2DData channelDataB, InterpolationMethod2D interpolation, double factor)
    {
     ...
     * 
     * 
     * @param imageA the first addition opperand
