...
public class PrewittOperator extends ImageFilter
{   
    private final double[][] gx = {{1, 0, -1}, {1,0,-1}, {1,0,-1}};
    private final double[][] gy = {{1, 1, 1}, {0,0,0}, {-1,-1,-1}};

    private final int scalingFactor = 6;
