...
public class SpinnerNumberModelTest extends AbstractSpinnerModel implements Serializable
{
    ...
    public SpinnerNumberModelTest(Number value,
            Comparable<?> minimum,
            Comparable<?> maximum,
            Number stepSize) {
     ...
     *     <code>minimum &lt;= value &lt;= maximum</code>
     */
    public SpinnerNumberModelTest(int value, int minimum, int maximum, int stepSize) {
     ...
     *     <code>minimum &lt;= value &lt;= maximum</code>
     */
    public SpinnerNumberModelTest(double value, double minimum, double maximum, double stepSize) {
