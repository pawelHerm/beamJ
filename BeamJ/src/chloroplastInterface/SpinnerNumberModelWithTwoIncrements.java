...
public class SpinnerNumberModelWithTwoIncrements extends AbstractSpinnerModel implements Serializable
{
    private Number increaseStep;
    private Number decreaseStep;
     ...
     * @param increaseStep the difference between the current and the next element of the sequence
     *
    ...
    public SpinnerNumberModelWithTwoIncrements(Number value,
            Comparable<?> minimum,
            Comparable<?> maximum,
            Number increaseStep, Number decreaseStep) {
        if ((value == null) || (increaseStep == null)) {
     ...
     * @param increaseStep the difference between the current and the next element of the sequence
     * @param decreaseStep the difference between the current and the previous element of the sequence
     * @throws IllegalArgumentException if the following expression is false:
     *     <code>minimum &lt;= value &lt;= maximum</code>
     */
    public SpinnerNumberModelWithTwoIncrements(int value, int minimum, int maximum, int increaseStep, int decreaseStep) {
        this(Integer.valueOf(value), Integer.valueOf(minimum), Integer.valueOf(maximum), Integer.valueOf(increaseStep),Integer.valueOf(decreaseStep));
    }
     ...
     * @param minimum the first number in the sequence
     * @param maximum the last number in the sequence
     * @param increaseStep the difference between elements of the sequence
     * @param decreaseStep the difference between elements of the sequence
     * @throws IllegalArgumentException   if the following expression is false:
     *     <code>minimum &lt;= value &lt;= maximum</code>
     */
    public SpinnerNumberModelWithTwoIncrements(double value, double minimum, double maximum, double increaseStep, double decreaseStep) {
        this(Double.valueOf(value), Double.valueOf(minimum),
                Double.valueOf(maximum), Double.valueOf(increaseStep), Double.valueOf(decreaseStep));
    }
     ...
     */
    public SpinnerNumberModelWithTwoIncrements() {
        this(Integer.valueOf(0), null, null, Integer.valueOf(1), Integer.valueOf(1));
    }
     ...
     *
     * @param increaseStepSize the size of the value change computed by the
     *     <code>getNextValue</code> method
     * @see #getNextValue
     * @see #getPreviousValue
     * @see #getStepSize
     * @see SpinnerModel#addChangeListener
     */
    public void setIncreaseStepSize(Number increaseStepSize) {
        if (increaseStepSize == null) {
            throw new IllegalArgumentException("null stepSize");
        }
        if (!increaseStepSize.equals(this.increaseStep)) {
            this.increaseStep = increaseStepSize;
            fireStateChanged();
        }
    }
     ...
     * @see #setIncreaseStepSize
     */
    public Number getIncreaseStepSize() {
        return increaseStep;
    }
     ...
     * <code>stepSize</code> has changed.
     *
     * @param decreaseStepSize the size of the value change computed by the
     *     <code>getPreviousValue</code> method
     * @see #getNextValue
     * @see #getPreviousValue
     * @see #getStepSize
     * @see SpinnerModel#addChangeListener
     */
    public void setDecreaseStepSize(Number decreaseStepSize) {
        if (decreaseStepSize == null) {
            throw new IllegalArgumentException("null stepSize");
        }
        if (!decreaseStepSize.equals(this.decreaseStep)) {
            this.decreaseStep = decreaseStepSize;
            fireStateChanged();
        }
    }
     ...
     *
     * @return the value of the <code>stepSize</code> property
     * @see #setDecreaseStepSize
     */
    public Number getDecreaseStepSize() 
    {
        return decreaseStep;
    }
    ...
    private Number incrValue()
    {
        ...
        if ((value instanceof Float) || (value instanceof Double)) {
            double v = value.doubleValue() + (increaseStep.doubleValue());
            ...
            long v = value.longValue() + (increaseStep.longValue());
    ...
    @SuppressWarnings("unchecked") // Casts to Comparable<Object>
    private Number dcrValue()
    {
        Number newValue;
        if ((value instanceof Float) || (value instanceof Double)) {
            double v = value.doubleValue() - (decreaseStep.doubleValue());
            if (value instanceof Double) {
                newValue = Double.valueOf(v);
            }
            else {
            ...
            long v = value.longValue() - (decreaseStep.longValue() );
